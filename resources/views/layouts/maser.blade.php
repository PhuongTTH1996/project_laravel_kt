...
<body class="hold-transition login-page">
    <div class="topnav-user" id="menu">
        <a  class="{{ Request::path() ==  'dien-thoai' ? 'active' : '' }}" href="/dien-thoai"><i class="fa fa-mobile"></i>Điện thoại</a>
        <a class="{{ Request::path() ==  'computer' ? 'active' : '' }}"  href="/computer"><i class="fa fa-laptop"></i>Laptop</a>
        ...
        {{--<div class="form-group col-md-4 ">--}}
            {{--<label>Tên:</label>--}}
            {{--{!! Form::text('search', \Request::query('search')) !!}--}}
        {{--</div>--}}
